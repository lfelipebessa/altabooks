    ...
    >
      ...
      {project.drive_url && (
        <div className="mt-auto pt-2">
            ...
            className="inline-flex items-center gap-1.5 text-sm text-brand-primary font-medium hover:text-brand-hover transition-colors mb-2 opacity-0 group-hover:opacity-100"
            >
